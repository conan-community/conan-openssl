...
The packages generated with this **conanfile** can be found in [conan.io](https://conan.io/source/OpenSSL/1.0.2h/lasote/stable1.2.8/lasote/stable).
...
## Upload packages to server
    ...
    $ conan upload OpenSSL/1.0.2h@lasote/stable --all
    
## Reuse the packages

### Basic setup

    $ conan install OpenSSL/1.0.2h@lasote/stable
